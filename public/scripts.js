...
const PhotosUpload = {
  ...
  removePhoto(event) {
    const photoDiv = event.target.parentNode //! tag pai (<div class="photo">) do target (<i>)
    const photosArray = Array.from(PhotosUpload.preview.children) //? lista do preview (fotos)
